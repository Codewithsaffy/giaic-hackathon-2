    ...
    return (
        <section className="relative pt-32 pb-20 px-6 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto flex flex-col items-center text-center relative z-10">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-neutral-900/50 border border-neutral-800 mb-8 animate-in slide-in-from-top-4 duration-1000">
                ...
                <h1 className="text-5xl md:text-8xl font-extrabold font-heading mb-8 tracking-tighter leading-[0.9] text-white">
                    Organize Your Work.<br />
                    <span className="text-gradient-white">Achieve Your Goals.</span><br />
                    Stay Consistent.
                </h1>

                <p className="text-lg md:text-xl text-neutral-400 font-light mb-12 max-w-2xl mx-auto leading-relaxed animate-in fade-in duration-1000 delay-300">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-6 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-500">
                    <Link
                        href="/auth/sign-up"
                        className="group relative px-10 py-5 bg-white text-black font-black uppercase text-xs tracking-widest rounded-full hover:scale-105 transition-all duration-300 flex items-center gap-3 shadow-2xl shadow-white/10"
                    >
                        Start Free
                        <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                    </Link>
                    <button
                        className="px-10 py-5 bg-transparent text-white font-black uppercase text-xs tracking-widest rounded-full border border-neutral-800 hover:bg-neutral-900 transition-all duration-300 flex items-center gap-3"
                    >
                ...
                <div className="mt-24 w-full max-w-5xl perspective-1000 animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-700">
                    <div className="relative group rounded-[2rem] border border-neutral-800 bg-black/40 backdrop-blur-3xl p-4 shadow-2xl rotate-x-12 group-hover:rotate-x-0 transition-transform duration-700">
