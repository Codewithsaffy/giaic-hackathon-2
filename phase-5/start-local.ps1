...
Start-Process kubectl -ArgumentList "port-forward svc/frontend 3000:80 --address 127.0.0.1" -NoNewWindow
Start-Sleep -Seconds 2

echo "Mapping Backend to http://localhost:8000..."
Start-Process kubectl -ArgumentList "port-forward svc/backend 8000:80 --address 127.0.0.1" -NoNewWindow
Start-Sleep -Seconds 2
